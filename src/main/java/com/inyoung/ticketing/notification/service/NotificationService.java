...
public class NotificationService {
	...
	public void addNotification(String userId, NotificationItemResponse item) {
	...
	public List<NotificationItemResponse> getNotifications(String userId) {
		String key = key(userId);
	...
	private String toJson(NotificationItemResponse item) {
		try {
	...
	private NotificationItemResponse fromJson(String value) {
		try {
			return objectMapper.readValue(value, NotificationItemResponse.class);
		} catch (JsonProcessingException e) {
