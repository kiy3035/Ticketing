...
import com.inyoung.ticketing.notification.dto.NotificationResponse;
...
public class NotificationController {
	...
	public NotificationResponse list(Authentication authentication) {
		List<NotificationItemResponse> items = notificationService.getNotifications(authentication.getName());
